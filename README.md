...
### [config-sentinel](https://github.com/raj-singh-giift/config-sentinel) &nbsp; [![npm](https://img.shields.io/npm/v/config-sentinel?style=flat)](https://www.npmjs.com/package/config-sentinel) [![npm downloads](https://img.shields.io/npm/dm/config-sentinel?style=flat&color=brightgreen)](https://www.npmjs.com/package/config-sentinel) [![CI](https://github.com/raj-singh-giift/config-sentinel/actions/workflows/ci.yml/badge.svg)](https://github.com/raj-singh-giift/config-sentinel/actions)
